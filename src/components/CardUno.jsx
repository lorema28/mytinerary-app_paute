...
export default function CardUno() {
  return (
    ...
    <div class=" flex col flex-wrap items-justify justify-left mt-2  ">
      ...
      <Anchor to= '/cities' className="bg-blue-600  text-gray-200  p-2 rounded  hover:bg-blue-500 hover:text-gray-100 px-5 py-2 font-bold text-1xl text-white rounded mt-2" type="button">View More</Anchor>
